...
?>
<script src="../js/console_tramite_area_rechazados.js?rev=<?php echo time(); ?>"></script>
...
<script>
  ...
  function generarReporteFiltrado() {
    ...
    let url = `MPDF/REPORTE/reporte_tramite_area_filtrado_rechazados.php?usu_id=${usuId}&fi=${fechaInicio}&ff=${fechaFin}`;
