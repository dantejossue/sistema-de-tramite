...
$area_origen = htmlspecialchars($_POST['area_origen'], ENT_QUOTES, 'UTF-8');
$area_destino = htmlspecialchars($_POST['area_destino'], ENT_QUOTES, 'UTF-8');


$consulta = $MU->Cambiar_Estado_Tramite($idtramite, $estado, $descripcion, $idusuario, $area_origen, $area_destino);
echo $consulta;
